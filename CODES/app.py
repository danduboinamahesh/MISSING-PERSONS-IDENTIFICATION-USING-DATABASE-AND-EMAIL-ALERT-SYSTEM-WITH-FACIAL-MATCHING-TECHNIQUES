...
with open("C:/my new project/Module3/details.json", "r") as jf:
    data = json.load(jf)
...
def signup():
    if request.method == 'POST':
        ...
        with open("C:/my new project/Module3/details.json", 'w') as jf:
...
def newReport():
    ...
    if request.method == 'POST':
        ...
        with open("C:/my new project/Module3/details.json", "w") as jfd:
